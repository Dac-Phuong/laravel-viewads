<div class="modal fade" id="kt_modal_update_viewer" tabindex="-1" aria-hidden="true" wire:ignore.self>
    <!--begin::Modal dialog-->
        ...
        <div class="modal-content">
            ...
            <div class="modal-header" id="kt_modal_add_user_header">
                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">Sửa thông tin người xem</h4>
                </div>
                <!--end::Modal title-->
                ...
                <form id="kt_modal_add_user_form" class="form" action="#" wire:submit.prevent="submit"
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="mb-2">
                                <label class="form-label" for="basic-icon-default-fullname">Tên chủ tài khoản</label>
                                <div class="input-group input-group-merge">
                                    <span id="basic-icon-default-fullname2" class="input-group-text"><i
                                            class="ti ti-user"></i></span>
